-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2025-02-28 10:13:01.177462
--
-- gnuplot@6.0.0%gcc@11.5.0~X+cairo+gd+libcerf~pbm~qt+readline~wx build_system=autotools patches=ad89f23 arch=linux-rocky9-zen2/gl57rir
--
...
prepend_path("PATH", "/apps/spack/gilbreth-r9/apps/gnuplot/6.0.0-gcc-11.5.0-gl57rir/bin", ":")
prepend_path("MANPATH", "/apps/spack/gilbreth-r9/apps/gnuplot/6.0.0-gcc-11.5.0-gl57rir/share/man", ":")
prepend_path("CMAKE_PREFIX_PATH", "/apps/spack/gilbreth-r9/apps/gnuplot/6.0.0-gcc-11.5.0-gl57rir/.", ":")
...
setenv("GNUPLOT_HOME", "/apps/spack/gilbreth-r9/apps/gnuplot/6.0.0-gcc-11.5.0-gl57rir")
setenv("RCAC_GNUPLOT_ROOT", "/apps/spack/gilbreth-r9/apps/gnuplot/6.0.0-gcc-11.5.0-gl57rir")
setenv("RCAC_GNUPLOT_VERSION", "/apps/spack/gilbreth-r9/apps/gnuplot/6.0.0-gcc-11.5.0-gl57rir")
append_path("MANPATH", "", ":")
