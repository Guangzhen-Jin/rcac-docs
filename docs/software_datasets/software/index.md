...
## Overview
As of **September 12, 2025**, there have been a total of **234** applications with **740** available versions deployed across **6** RCAC HPC clusters: **ANVIL, BELL, GAUTSCHI, GILBRETH, NEGISHI, SCHOLAR**.
...
-   :material-application:{ .lg .middle } __Fluid Dynamics__
    ...
    [:octicons-arrow-right-24: Fluid Dynamics](fluid_catalog.md)
...
-   :material-application:{ .lg .middle } __MPIs__
    ...
    [:octicons-arrow-right-24: MPIs](mpi_catalog.md)
...
-   :material-application:{ .lg .middle } __Audio/Visualization__
    ...
    [:octicons-arrow-right-24: Audio/Visualization](audio_vis_catalog.md)
